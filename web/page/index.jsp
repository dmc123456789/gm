...
<div class="layui-layout layui-layout-admin">
    <div id="head"  class="layui-header">
        ...
        <ul class="layui-nav layui-layout-right">
            <li class="layui-nav-item">
                <a href="javascript:;">
                    <img src="static\back\Image\3.png" class="layui-nav-img">
                    欢迎${sessionScope.Superuser.userName}
                </a>
                <dl class="layui-nav-child">
                    <dd><a target="iframe_context" href="doadmin?action=queryById&Id=${sessionScope.Superuser.id}">基本资料</a></dd>
            ...
            <ul id="left2" class="layui-nav layui-nav-tree"  lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a target="iframe_context"  href="doadmin?action=queryall&pageNumber=1">查询顾客</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a class="layui-icon" href="javascript:;" style="color:#9FC105">&#xe621;&nbsp;&nbsp;分类管理</a>
                    <dl class="layui-nav-child">
                        <dd><a target="iframe_context" href="doBigclass?action=Bigclassquery&pageNumber=1">大分类管理</a></dd>
                        <dd><a target="iframe_context" href="doSmallclass?action=smallquery&pageNumber=1">小分类管理</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a target="iframe_context" href="doAnnouncement?action=aquery&pageNumber=1">查询公告</a></dd>
                        <dd><a target="iframe_context" href="page/addAnnouncement.jsp">添加公告</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a class="layui-icon" href="javascript:;" style="color:#9FC105">&#xe770;&nbsp;&nbsp;商家管理</a>
                    <dl class="layui-nav-child">
                        <dd><a target="iframe_context" href="doseller?action=aquery&pageNumber=1">查询商家</a></dd>
                        <dd><a target="iframe_context" href="page/addseller.jsp">添加商家</a></dd>
                    </dl>
                </li>
    ...
    <div id="main" class="layui-body">
        ...
        <div style="padding: 15px;">
            ...
            <iframe name="iframe_context" frameborder="0" id="context" src="page/banner.jsp"  ></iframe>
        </div>
    </div>
